 ...
 */
final class Version20230905093112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, recipe_id INT DEFAULT NULL, user_id INT NOT NULL, comment LONGTEXT DEFAULT NULL, note INT NOT NULL, INDEX IDX_794381C659D8A214 (recipe_id), INDEX IDX_794381C6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
