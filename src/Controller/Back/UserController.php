...
class UserController extends AbstractController
{
    ...
    public function register(
        ...
        // On définit les propriétés email et password sur l'utilisateur
        $user->setEmail($email);
    ...
    /**
     * @Route("/users/me/favorites", name="app_user_favorites", methods={"GET"})
     */
    ...
    /**
     * @Route("/users", name="app_user", methods={"POST"})
     */
